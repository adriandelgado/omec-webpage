...
<article class="rounded-md border border-primary bg-white p-4 shadow-[4px_4px_0_0_#2d67ff]">
	...
	<h3 class="mt-3 max-w-[14ch] text-[17px] leading-tight font-medium text-copy">{title}</h3>
	<p class="mt-2.5 text-[13px] leading-[1.6] text-copy/70">{description}</p>
	<ul class="mt-3.5 space-y-1.5 text-[13px] leading-normal text-copy/80">
