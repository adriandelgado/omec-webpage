<script lang="ts">
	...
	const social_links = [
		...
		},
		{
			...
			class_name: "bg-[#ff2f92] text-white",
		...
		},
		{
			...
			class_name: "bg-[#2aa7ff] text-white",
			...
			<div class="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-10">
				<div class="max-w-110">
					...
					<div class="mt-5 space-y-3.5">
						{#each contact_cards as card (card.title)}
							<div
								class="rounded-2xl border border-primary/35 bg-white/80 px-4 py-4 shadow-[0_10px_30px_rgba(45,103,255,0.05)]"
							>
						...
						<div class="mt-4 flex items-center gap-3">
							{#each social_links as social_link (social_link.label)}
								...
								<a
									...
									class={`inline-flex h-10 w-10 items-center justify-center rounded-xl shadow-[0_12px_24px_rgba(36,52,71,0.08)] transition-transform hover:-translate-y-0.5 ${social_link.class_name}`}
								>
				...
				<div class="lg:justify-self-end lg:pt-1">
					<form
						...
						class="rounded-[28px] border border-primary/35 bg-white/88 px-5 py-5 shadow-[0_18px_60px_rgba(45,103,255,0.08)] lg:w-116 lg:px-6 lg:py-6"
					>
