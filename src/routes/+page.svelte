...
<main class="isolate">
			...
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				<div class="mx-auto max-w-2xl text-center">
					<h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
						Olimpiada Matemática Ecuatoriana
					</h1>
					<p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
						Desarrollando el talento matemático de los estudiantes ecuatorianos y promoviendo la
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		...
		<div class="mt-16 flex justify-center">
			<p
				class="relative rounded-full bg-white/25 px-4 py-1.5 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 ring-inset"
			>
	...
	<div class="py-24 sm:pt-48">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			...
			<p
				class="mx-auto mt-6 max-w-2xl text-center text-lg/8 text-pretty text-gray-600 sm:text-xl/8"
			>
			...
			>
				<div
					class="-mr-px flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 ring-inset lg:mt-8 lg:rounded-r-none xl:p-10"
				>
					<div>
				...
				<div
					class="flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 ring-inset lg:z-10 lg:rounded-b-none xl:p-10"
				>
					<div>
						<div class="flex items-center justify-between gap-x-4">
					...
					<a
						...
						class="mt-8 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
						>Buy plan</a
					>
				</div>
				<div
					class="-ml-px flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 ring-inset lg:mt-8 lg:rounded-l-none xl:p-10"
				>
					<div>
						<div class="flex items-center justify-between gap-x-4">
